import { ChainId, Currency, NATIVE, WNATIVE, WNATIVE_ADDRESS } from '@bionswap/core-sdk';
...
export function useCurrency(currencyId: string | undefined): Currency | null | undefined {
  ...
  const { native, wnative } = useMemo(
    () => ({
      native: chainId && chainId in NATIVE ? NATIVE[chainId as keyof typeof NATIVE] : undefined,
